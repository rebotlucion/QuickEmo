...
QE_SpeechTextModel # Es un paquete para almacenar un volcado de los parámetros del modelo que hemos conseguido entrenar, tiene tanto la parte de speech como la de text
